      ...
      <div className="filter-group">
        ...
        <select className="sort-select" value={sortBy} onChange={e => onSortChange(e.target.value)}>
          <option value="default">Default</option>
           <option value="price-asc">Price: Low to High</option>      {/*BUG 8 : FIXED : Sort order swapped */}
          <option value="price-desc">Price: High to Low</option>        {/*BUG 8 : FIXED : Sort order swapped */}
